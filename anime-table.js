(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ReactAnimeTable"] = factory(require("react"));
	else
		root["ReactAnimeTable"] = factory(root["React"]);
...
var _CekiTable = __webpack_require__(1);

var _CekiTable2 = _interopRequireDefault(_CekiTable);
...
var headers = ['title', 'studio', 'year', 'score'];
var rows = [['Great Teacher Onizuka', 'Studio Pierrot', 1999, 9.2140], ['Code Geass: Lelouch of the Rebellion R2', 'Sunrise', 2008, 9.1745], ['Fullmetal Alchemist: Brotherhood', 'Bones', 2009, 9.1692], ['Clannad After Story', 'Kyoto Animation', 2008, 9.1577], ['Steins;Gate', 'White Fox', 2011, 9.1529]];

var AnimeTable = function (_Component) {
    _inherits(AnimeTable, _Component);

    function AnimeTable() {
        _classCallCheck(this, AnimeTable);

        var _this = _possibleConstructorReturn(this, (AnimeTable.__proto__ || Object.getPrototypeOf(AnimeTable)).call(this));
    ...
    _createClass(AnimeTable, [{
        ...
        value: function render() {
            return _react2.default.createElement(
                'div',
                null,
                _react2.default.createElement(_CekiTable2.default, { headers: headers, rows: this.state.rows }),
                _react2.default.createElement(
                    'button',
                    { onClick: this.getMore.bind(this), disabled: rows.length === this.state.rows.length },
                    'get more anime pls'
                )
            );
        }
